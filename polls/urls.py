...
from .apiviews import ChoiceList, CreateVote, LoginView,\
    PollViewSet, UserCreate, PollDestroy
...
urlpatterns = [
    ...
    path(
        "api/polls/<int:pk>/choices/", ChoiceList.as_view(), name="choice_list"
    ),
    ...
    path(
        r'api/polls/<int:pk>/delete', PollDestroy, name='polls_destroy'
    ),
